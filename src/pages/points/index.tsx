    ...
    return (
        <>
          <View style={styles.container}>
              ...
              <Text style={styles.title}><Emoji name="smile" style={{fontSize: 16}} /> Bem-vindo!</Text>
              ...
              <View style={styles.mapContainer}>
                  { initialPosition[0] !== 0 && (
                    ...
                    initialRegion={{ latitude: initialPosition[0], longitude: initialPosition[1], latitudeDelta: 0.014, longitudeDelta: 0.014}}>
                      {points.map(point => (
                        <Marker key={String(point.id)} onPress={() => navigateToDetail(point.id)} style={styles.mapMarker} coordinate={{ latitude: point.latitude, longitude: point.longitude}}>
